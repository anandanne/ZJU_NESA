...
def construct_generation_args():
    ...
    # pre-parsing args
    parser.add_argument("--relation_id", type=str, default="P530")
    ...
    # directories
    parser.add_argument("--data_dir", type=str, default='/home/wrc/attack_on_prompt_learning/P_tuning/data/LAMA')
    parser.add_argument("--out_dir", type=str, default=join(abspath(dirname(__file__)), '/home/wrc/attack_on_prompt_learning/P_tuning/out/LAMA'))
    # MegatronLM 11B
    parser.add_argument("--checkpoint_dir", type=str, default=join(abspath(dirname(__file__)), '/home/wrc/attack_on_prompt_learning/P_tuning/checkpoints'))
