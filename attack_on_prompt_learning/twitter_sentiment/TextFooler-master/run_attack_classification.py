...
#           '--USE_cache_path /scratch/jindi/tf_cache'
command= '''python attack_classification.py --dataset_path data/ag --target_model bert --target_model_path bert-base-uncased --max_seq_length 256 --batch_size 32 --counter_fitting_embeddings_path counter-fitted-vectors1.txt --counter_fitting_cos_sim_path cos_sim_counter_fitting.npy >1.txt &'''
os.system(command)