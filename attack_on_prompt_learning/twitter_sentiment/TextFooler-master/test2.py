...
# import pandas as pd 
# tsv_file="data/sst-2/train.tsv"
# csv_table=pd.read_table(tsv_file,sep='\t')
# csv_table.to_csv('data/sst-2/train.csv',index=False)

# tsv_file="data/sst-2/dev.tsv"
# csv_table=pd.read_table(tsv_file,sep='\t')
# csv_table.to_csv('data/sst-2/dev.csv',index=False)

# tsv_file="data/sst-2/test.tsv"
# csv_table=pd.read_table(tsv_file,sep='\t')
# csv_table.to_csv('data/sst-2/test.csv',index=False)
...
train_dataset = load_dataset("csv",data_files="data/sst-2/train.csv", split="train[:60000]")
dev_dataset = load_dataset("csv",data_files="data/sst-2/train.csv", split="train[60000:]")
test_dataset = load_dataset("csv",data_files="data/sst-2/dev.csv", split="train[:]")
...
ckpt = torch.load("/home/wrc/attack_on_prompt_learning/twitter_sentiment/TextFooler-master/results/checkpoint-500/pytorch_model.bin", map_location='cpu')  # Load your best model
