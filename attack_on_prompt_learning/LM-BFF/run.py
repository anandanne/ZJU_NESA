...
class DynamicTrainingArguments(TrainingArguments):
    ...
    evaluate_during_training: bool=field(
        default=True,
        metadata={"help": "whether to evaluate during training"}
    )
def my_parser(args):
    model_args=ModelArguments(args.model_name_or_path)
    data_args= DataTrainingArguments(args.task_name, args.data_dir)
    training_args = DynamicTrainingArguments(args.output_dir)

    data_args.template = args.template
    data_args.mapping =args.mapping
    data_args.num_k=args.num_k
    data_args.num_sample=args.num_sample
    data_args.prompt_path=None
    data_args.template_path=None
    data_args.mapping_path=None
    data_args.auto_demo=True
    data_args.gpt3_in_context_head=False
    data_args.gpt3_in_context_tail=False
    data_args.gpt3_in_context_num=32
    data_args.template_list=None
    data_args.demo_filter=False
    data_args.double_demo=False
    data_args.first_sent_limit=None
    data_args.other_sent_limit=None
    data_args.truncate_head=None
    data_args.prompt=None
    ...
    model_args.few_shot_type=args.few_shot_type
...
def main():
    ...
    model_args, data_args, training_args=my_parser(args)
